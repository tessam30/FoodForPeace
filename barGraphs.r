...
aggYear <- as.data.frame(summaryBy(decTotalNom + decTotal ~ year, data = d, FUN = sum))
setwd("C:/Users/t/Box Sync/FoodForPeace/Excel/")
write.csv(aggYear, file = "DecadeAggregates.csv")
